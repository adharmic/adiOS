export default function Loader() {
  return (
    <div className="absolute loader flex flex-col w-screen h-screen rounded items-center justify-center bg-[rgba(0,0,0,0.4)] z-90">
      <div className="window w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="content w-full h-full p-4 flex flex-col justify-center items-center text-white gap-8">
          ...
          <div className="glass progress border-2 border-white w-3/4 h-16 rounded-xl p-2 flex gap-2 lg:w-1/2">
