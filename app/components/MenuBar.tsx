...
export default function MenuBar() {
  ...
  return (
    <div className="glass opacity-0 !bg-[#1621c9]/40 menuBar w-full translate-y-full flex justify-center sm:justify-start h-16 max-h-16">
      ...
      <div className="ml-auto h-full items-center justify-center p-4 rounded-[16px] border-[rgba(255,255,255,0.3)] border-l !rounded-l-none !bg-[#fff]/20 hidden md:flex">
